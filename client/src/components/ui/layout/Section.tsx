	...
	return (
		<section
			...
			className={`${className} relative overflow-hidden bg-gradient-to-br from-yellow-950/30 to-black/40 backdrop-blur-3xl border border-white/5 rounded-2xl p-8 md:p-12 transition-all duration-700 w-full group
					before:absolute before:inset-0 before:bg-gradient-to-br before:from-amber-500/5 before:to-transparent before:opacity-0 before:animate-[pulse_8s_ease-in-out_infinite] before:pointer-events-none
