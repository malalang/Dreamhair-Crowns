            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['Home', 'Shop', 'Services', 'Gallery', 'About Us', 'Contact'].map((item) => (
                                <li key={item}>
                                    <Link href={item === 'Home' ? '/' : `/${item.toLowerCase().replace(' ', '-')}`} className="text-white/60 hover:text-amber-500 transition-colors inline-flex items-center gap-2 group">
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-center gap-3 text-white/60">
                                ...
                                <span>083 588 7070</span>
                            </li>
                            <li className="flex items-center gap-3 text-white/60">
                                <HiMail className="text-amber-500 text-xl flex-shrink-0" />
                                <span>glendamahasha@icloud.com</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-white/40 text-sm">
                        &copy; {currentYear} DREAMHAIR CROWNS. All rights reserved.
                    </p>
