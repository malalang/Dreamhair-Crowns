...
import CategoryCard from '@/app/shop/components/CategoryCard';
import NoResults from '@/app/shop/components/NoResults';
								...
								<div className='space-y-8'>
									...
									<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
										{matchingProducts.map((product) => {
											...
											const categorySlug = productCategoryMap?.get(product.ProductID) || 'general';
											return (
												<ProductCard
