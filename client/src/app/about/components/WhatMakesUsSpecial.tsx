import { IoSparkles, IoCalendar, IoPeople, IoHeart } from 'react-icons/io5';
	...
	return (
		<Section tittle='Our Distinctive Edge' Icon={IoSparkles}>
			<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
				{
					[
						{ icon: IoSparkles, title: 'Premium Sourcing', desc: "Direct relationships with trusted suppliers ensuring consistent, high-grade bundles and lace." },
						{ icon: IoCalendar, title: 'Seamless Shopping', desc: "An intuitive online store with secure checkout and reliable nationwide delivery." },
						{ icon: IoPeople, title: 'Expert Curation', desc: "Every item is hand-selected by beauty experts to ensure it meets our rigorous standards." },
						{ icon: IoHeart, title: 'Complete Care', desc: "From purchase to installation advice, we support your entire hair journey." },
					].map((item, idx) => (
